...
export const Route = createFileRoute('/_home/roles/edit/$id')({
  component: EditRole,
  loader: async (opt) => {
    return (await axiosInstance.get('//' + routesEnum.roles + opt.params.id)).data;
  },
});
      ...
      <div ref={ref}>
        <form
          ...
          onSubmit={async (e) => {
            e.preventDefault();
            try {
              await toast.promise(axiosInstance.patch(`${routesEnum.roles}/${id}`, { name }), {
